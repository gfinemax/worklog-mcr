...
export default function ShiftRotationSettings() {
        ...
        <MainLayout>
            <div className="space-y-6 max-w-6xl mx-auto pb-20">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold">근무 패턴 설정</h1>
                        <p className="text-gray-500">순환 근무 규칙과 역할 교대 패턴을 관리합니다.</p>
                    </div>
