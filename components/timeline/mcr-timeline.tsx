        ...
        <div className="h-full space-y-4">
            <Tabs defaultValue="config" className="h-full flex flex-col">
                <div className="flex items-center mb-4">
                    <TabsList>
                        <TabsTrigger value="config">설정 이력 (Config)</TabsTrigger>
                        <TabsTrigger value="audit">변경 이력 (Audit)</TabsTrigger>
                    </TabsList>
                </div>

                <TabsContent value="audit" className="flex-1 mt-0 h-full">
                ...
                <TabsContent value="config" className="flex-1 mt-0 h-full">
                    <ConfigHistoryList />
                </TabsContent>
            </Tabs>
        </div>
