...
>(({ className, ...props }, ref) => (
    <TabsList
        ref={ref}
        className={cn(
            "flex items-end w-full border-b border-border pl-0",
            className
        )}
        {...props}
    />
...
>(({ className, children, ...props }, ref) => (
    ...
    >
        ...
        <div className={cn(
            ...
            "bg-transparent",
            "group-data-[state=active]:bg-border",
            "group-data-[state=active]:shadow-[0_-2px_6px_rgba(0,0,0,0.05)] dark:group-data-[state=active]:shadow-none",
        )}
            style={{
        ...
        <div className={cn(
            ...
            // Active
            "group-data-[state=active]:bg-card",
            "group-data-[state=active]:mb-[-1px] group-data-[state=active]:pb-[2px]",
        )}
            style={{
                clipPath: "polygon(0 0, calc(100% - 15px) 0, 100% 100%, 0 100%)",
        ...
        {/* Content */}
        <span className={cn(
            "relative z-20 truncate max-w-[150px] transition-colors duration-200 mr-2",
            "group-data-[state=active]:text-foreground group-data-[state=active]:font-bold",
            "group-data-[state=inactive]:text-muted-foreground group-data-[state=inactive]:group-hover:text-foreground",
        )}>
            {children}
        </span>
        ...
        <div className={cn(
            "absolute bottom-[-1px] left-0 right-0 h-[2px] bg-card z-20 hidden",
