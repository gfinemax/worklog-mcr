...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Click the 로그인 button to submit the login form
        ...
        try:
            ...
            raise AssertionError('Test case failed: The user was unable to log in successfully or the session was not persisted after page refresh as per the test plan.')
